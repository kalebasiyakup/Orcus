using Orcus.Core.Attribute;
using Orcus.Core.ExceptionHandling;
using System;
...
namespace Orcus.Core.Helper
{
    public static class EnumHelper
    {
        ...
        public static T GetAttribute<T>(Enum enumValue) where T : System.Attribute
        {
            T retVal = null;
        ...
        public static List<Orcus.Core.Model.EnumerationModel> ConvertToList<T>()
        {
            List<Orcus.Core.Model.EnumerationModel> retVal = new List<Orcus.Core.Model.EnumerationModel>();
            ...
            try
            {
                ...
                {
                    var item = new Orcus.Core.Model.EnumerationModel();
